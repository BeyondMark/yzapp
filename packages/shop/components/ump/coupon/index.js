        ...
        properties: {
          ...
          bottomRightIcon: {
            ...
            observer(e) {
              this.setYZData({
                showCheckIn: !!e,
                getBRUrl: "string" == typeof e ? e : void 0,
              });
            },
          },
          hideBtnWrap: Boolean,
          ...
          isCheckbox: { type: Boolean, value: !1 },
          checkboxValue: { type: Boolean, value: !1 },
          btnType: String,
          btnText: String,
          btnIcon: { type: String, optionalTypes: [Boolean], value: "arrow" },
        },
        options: { multipleSlots: !0 },
        data: { showCheckIn: !1, getBRUrl: "" },
        methods: {
          handleBtnClick(e) {
      ...
      o.a = Behavior({
        properties: {
          themeClass: {
            ...
            observer(e) {
              var o = t[e] || {},
                { mainColor: r, borderColor: l, bgColor: a } = o,
                b = "",
                n = "",
                c = "",
                s = "";

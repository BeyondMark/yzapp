        ...
        var k = (e, a) => {
          ...
          S = function (e, a) {
            ...
            if ((A && (M.banner_id = A), "chat" === (l = O || l)));
              ...
              if (!H) return;
              var { feedId: z, nonceId: Y } = JSON.parse(H);
      ...
      cqgp: function (e, a, t) {
        ...
        a.a = function (e) {
          var a = e.profitRange,
            ...
            g = u.minCommissionStr,
            m = u.maxCommissionAmount,
            v = m !== u.minCommissionAmount,
            f = {
              commissionText: "分享后最高赚" + p,
              commissionRangeText: "分享后预计可赚 " + g + " - " + p,
              commissionRange: t,
              maxCommission: m,
              unit: r,
              maxCommissionStr: m > 0 ? p : "",
              isMultiCommission: v,
            };
          return i(i({}, f), {

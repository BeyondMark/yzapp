        ...
        var k = (e, a) => {
          ...
          S = function (e, a) {
            ...
            var { dmc: t } = Object(f.a)(),
              ...
              $ = { kdt_id: P },
              G = {};
            if ((I && (G.banner_id = I), "chat" === (l = O || l)));
            else if ("homepage" === l)
              t.switchTab("Home", Object(n.a)({}, G, $)).catch(() => {
                t.navigate("Home", Object(n.a)({}, G, $));
              });
            else if ("goods" === l && b) {
              var { image: M = {} } = D || {};
              t.navigate("GoodsDetail", Object(n.a)({ alias: b }, S, G), {
                bizParams: {
                  alias: b,
                  image: { url: A || M.url, width: M.width, height: M.height },
                  title: U,
                },
              });
            } else if ("feature" === l && b)
              t.navigate("Feature", Object(n.a)({ alias: b }, G));
            else if ("tag" === l) {
              var F = b ? { alias: b } : u.a.getAll(_);
              F.alias &&
                t.navigate(
                  "GoodsTag",
                  Object(n.a)({ alias: F.alias, title: y }, G)
                );
            } else if ("cart" === l)
              t.switchTab("Cart", Object(n.a)({}, G, $)).catch(() => {
                t.navigate("Cart", Object(n.a)({}, G, $));
              });
            else if ("usercenter" === l)
              t.switchTab("Usercenter", Object(n.a)({}, G, $)).catch(() => {
                t.navigate("Usercenter", Object(n.a)({}, G, $));
              });
            else if ("shopnote" === l)
              t.switchTab("Shopnote", Object(n.a)({}, G, $)).catch(() => {
                t.navigate("Shopnote", Object(n.a)({}, G, $));
              });
            else if ("allgoods" === l)
              t.navigate("AllGoodsList", Object(n.a)({ title: y }, G));
            else if ("coupon" === l)
              t.navigate(
                "CouponDetail",
                Object(n.a)(
              ...
              t.navigate("PointGoodsList", Object(n.a)({}, G, $));
            else if ("seckill" === l)
              t.navigate(
                "Seckill",
                Object(n.a)({ alias: b }, L ? { goodsAlias: L } : {}, G)
              );
            else if ("bargain" === l)
              t.navigate(
                "GoodsDetail",
              ...
              t.navigate("PaidContentColumn", Object(n.a)({ alias: b }, G));
            else if ("paidcontent" === l)
              t.navigate("PaidContentContent", Object(n.a)({ alias: b }, G));
            else if ("mypaidcontent" === l)
              t.navigate("PaidContentList", Object(n.a)({}, G, $));
            else if ("paidlive" === l)
              t.navigate("PaidContentLive", Object(n.a)({ alias: b }, G));
            else if ("allcourse" === l)
              t.navigate("EduGoodsList", Object(n.a)({}, G, $));
            else if (
              "course" === l ||
              "educourse" === l ||
              "allofflinecourse" === l ||
              ...
              var q = _.replace(/^http(s)?:\/\/shop\d+-?\d+/, "https://h5");
              t.navigate("EduWebview", Object(n.a)({ targetUrl: q }, G));
            } else if ("link" === l) {
              var { linkUrl: E } = e;
              E &&
                /mp.weixin.qq.com\/s/.test(E) &&
                t.navigate("CommonWebview", Object(n.a)({ src: E }, G));
              ...
              if (
                ...
                var N = u.a.getAll(d);
                if (N.weappSharePath) {
                  var W = decodeURIComponent(N.weappSharePath);
                  (W = u.a.remove(W, "shopAutoEnter")),
                    (N.weappSharePath = W),
                    (d = u.a.add("/pages/common/blank-page/index", N));
                }
              }
              if (!c()(a) && !p) {
                var { banner_id: H } = a;
              ...
              t.navigate("Checkin", Object(n.a)({}, $, G));
            else if ("zodiac" === l)
              t.navigate("LuckyLottery", Object(n.a)({ alias: b }, G));
            else if ("shopnote_detail" === l)
              t.navigate("ShopnoteDetail", Object(n.a)({ noteAlias: b }, G));
            else if ("mp_article" === l)
              t.navigate("MpArticle", Object(n.a)({ noteAlias: b }, G));
            else if (
              "hotellist" === l ||
              "recharge_center" === l ||
              "point_coupon" === l ||
              ...
              t.navigate("CommonWebview", Object(n.a)({ src: _ }, G));
            else if ("period_list" === l)
              t.navigate("PeriodBuyList", Object(n.a)({}, $, G));
              ...
              if (!Y) return;
              var { feedId: K, nonceId: z } = JSON.parse(Y);
              ...
              if ("member_code" === l)
                ...
                if (V) {
                  var Z = m()(
                    u.a.add("/wscshop/showcase/shop-ranking-list", { type: V }),
                    "h5",
                    P
                  );
                  o.default.$native.navigateTo({
                ...
                var {} = e,
                  Q = Object(i.a)(e.videoDynamicParams, w);
                ((e) => {
                  var a = v(e);
                  Object(g.a)().log({
                    et: "click",
